...
from src.ours.methods.bfs_8b import solve
...
def run(args):
    ...
    file = f'./logs/{args.task}/{args.backend}_{args.n_lambda_value}_{args.task_start_index}_{args.task_end_index}_v7.json'
