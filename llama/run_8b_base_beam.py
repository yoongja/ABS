...
from src.ours.methods.bfs_8b_base import solve
...
def run(args):
    ...
    file = f'./logs/{args.task}/{args.backend}_{args.n_lambda_value}_{args.task_start_index}_{args.task_end_index}_v7_{args.method_select}.json'
...
def parse_args():
    ...
    args.add_argument('--task', type=str, required=True, choices=['game24', 'text', 'crosswords','gsm8k', 'aqua', 'svamp', 'commonsenseqa', 'strategyqa', 'object_counting', 'date_understanding'])
    ...
    args.add_argument('--beam_adjustment', type=bool, default=True)
